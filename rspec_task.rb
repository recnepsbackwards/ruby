...
# Story: As a developer, I can give a Task a title and retrieve it.
  ...
  it 'should be able to give a title and retrieve it' do
    a_task = Task.new
    a_task.give_title = 'Walk the cat'
...
# Story: As a developer, I can give a Task a description and retrieve it.
  ...
  it 'should be able to give a description and retrieve it' do
    a_task = Task.new
    a_task.give_description = 1
    expect(a_task.description).to eq 'Description: 1'
    a_task.give_description = 'something'
...
# FIXME new line escape
  it 'should always have field labels and values' do
    a_task = Task.new
    a_task.give_title = "do this"
    a_task.give_description = "more stuff"
    expect(a_task.details).to be_a String
    expect(a_task.details).to eq 'Title: do this /n Description: more stuff Status: This task is not done.'
  end
